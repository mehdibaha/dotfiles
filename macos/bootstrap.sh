...
BREW_RECIPES=(bash mas coreutils git git-extras tree wget heroku mongodb node openssl python python3 trash youtube-dl dockutil hub fd)
BREW_CASKS=(spectacle skype vlc docker the-unarchiver sublime-text)
